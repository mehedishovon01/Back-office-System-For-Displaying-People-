    ...
    <div class="row">
        <div class="col-sm-10 col-sm-offset-1">
            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <!-- INPUTS -->
                <form action="{{ route('manufactured.store') }}" method="post">
                    @csrf
                    <div class="row" style="width: 100%; margin: 0 0 20px !important;">
                        <div class="col-sm-12 px-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input id="opening_quantity" name="opening_quantity" onkeypress="return event.charCode >= 46 && event.charCode <= 57" type="text" class="form-control input-sm" placeholder="Product Opening Stock" value="{{ old('opening_quantity') }}">
                                </div>
                            </div>
