                ...
                <div class="widget-toolbar border smaller" style="padding-right: 0 !important">
                    <div class="pull-right tableTools-container" style="margin: 0 !important">
                        <div class="dt-buttons btn-overlap btn-group">
                            ...
                            <a href="{{route('production.index')}}" class="dt-button btn btn-white btn-info btn-bold" title="Create New" data-toggle="tooltip" tabindex="0" aria-controls="dynamic-table">
                                <span>
            ...
            <form action="{{ route('production.store') }}" method="post">
                ...
                <div class="row" style="width: 100%; margin: 0 0 20px !important;">
                    <div class="col-sm-12 px-4">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 control-label" for="name"> <b>Category</b> </label>
                            <div class="col-sm-9">
                                <select required id="factory_id" name="category_id" class="chosen-select-100-percent" data-placeholder="- Select Factory Name -">
                                    <option></option>
                                            ...
                                            <td>
                                                <div class="col-sm-12 prod-price">
                                                    <select required name="product_id" onchange="enableQty('quantity-enable', 'unit', 'quantity', 'hide-unitid', this)" class="input-qty input-sm chosen-select-100-percent" data-placeholder="- Select Account -">
                                                        ...
                                                        <option value="{{ $value->id }}" data-unit="{{ $value->unit->name }}" data-unid="{{ $value->unit->id }}" data-qty="{{ $value->opening_quantity }}">{{ $value->name }}</option>
                                                        @endforeach
                                                    </select>
                        ...
                        <div class="pull-right mt-5">
                            <button id="draft" class="btn btn-sm btn-primary save-btn">
                                ...
                                <input type="hidden" name="is_approved" class="draft-value" value="1">
                            </button>
                        ...
                        <td>
                            <div class="col-sm-12 prod-price">
                                <select required name="product_id[]" onchange="enableQty('quantity-enable', 'unit', 'quantity', 'hide-unitid', this)" class="input-qty input-sm chosen-select-100-percent" data-placeholder="- Select Account -">
                                    <option></option>
                                    @foreach($manufactured_prod as $value)
                                    <option value="{{ $value->id }}" data-unit="{{ $value->unit->name }}" data-qty="{{ $value->opening_quantity }}">{{ $value->name }}</option>
                                    @endforeach
                                </select>
