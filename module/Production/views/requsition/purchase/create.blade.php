...
@section('page-header')
<i class="fa fa-list"></i> Requisition Purchase Create
@stop
@push('style')
                ...
                <div class="row" style="width: 100%; margin: 0 0 20px !important;">
                    <div class="col-sm-12 px-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input required name="purchase_date" class="form-control date-picker" id="id-date-picker-1" type="text" value="{{ date('Y-m-d') }}" data-date-format="yyyy-mm-dd">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 control-label" for="name"> <b>Reference</b> </label>
                            <div class="col-sm-9">
                                <input required name="reference" class="form-control " type="text" placeholder="Reference">
                            </div>
                        </div>
                                ...
                                <table id="myTable" class="table table-bordered order-list">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="text-right" width="120px;">Required Qty</td>
                                            <td width="50px;"></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-sm-12 prod-price">
                                                    <select required name="product_id[]" onchange="enableQty('quantity-enable', 'unit', 'quantity', 'hide-unitid', this)" class="input-qty input-sm chosen-select-100-percent" data-placeholder="- Select Account -">
                                                        ...
                                                        <option value="{{ $data['id'] }}" data-unit="{{ $data['unitName'] }}" data-unid="{{ $data['unitId'] }}" data-qty="{{ $data['qty'] }}">{{ $data['name'] }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <input name="unit_id[]" class="hide-unitid" type="hidden">
                                            ...
                                            <td>
                                                <input required name="required_qty[]" disabled type="text" onkeypress="return checkOnlyNumber(event)" class="form-control input-sm text-right quantity-enable " />
                                                @error('credit')
                                                <span class="text-danger"> {{ $message }}</span>
                                                @enderror
                                            </td>
