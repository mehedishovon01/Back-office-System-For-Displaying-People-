...
@section('page-header')
<i class="fa fa-list"></i> Direct Sales List
@stop
    ...
    <form class="form-horizontal" action="" method="get">
        ...
        <div class="col-sm-12">
            <table class="table table-bordered">
                ...
                <tr>
                    <td colspan="5" class="text-center" style="font-size:20px"><strong>Sales List</strong></td>
                </tr>
        ...
        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><span class="label label-purple label-white middle">Soled</span>
                    </td>
